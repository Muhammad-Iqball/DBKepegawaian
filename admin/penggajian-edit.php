	...
	<?php 
		if(isset($_POST["tblEdit"])){
			...
			if($db->connect_errno == 0){
				...
				$gaji = $db->escape_string($_POST['gaji']);
				$sql = "UPDATE penggajian SET idPegawai = '$idPegawai', tanggal = '$tanggal', totalGaji = '$gaji' WHERE idPenggajian = '$id'";
				$res = $db->query($sql);
				if($res){
